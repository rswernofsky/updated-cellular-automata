...
/**
 * Interface that dictates that all cells can get their current state (on/off), draw themselves,
 * and produce a child cell of itself given its left and right neighboring cells.
 */
public interface Cell {
  /**
   * Returns the row that this cell is in, starting at 0.
   * @return this cell's row
   */
  int getRow();

  /**
   * Returns the column that this cell is in, starting at 0.
